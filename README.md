...
```bash
bash <(curl -Ls https://raw.githubusercontent.com/necvilen/hacking-tools/main/liteedition.sh)
```

### RED/Core Edition
```bash
bash <(curl -Ls https://raw.githubusercontent.com/necvilen/hacking-tools/main/rededition.sh)
```
