...
```bash
sudo bash <(curl -sSL https://raw.githubusercontent.com/necvilen/hacking-tools/main/liteedition.sh)
```

### RED/Core Edition
```bash
sudo bash <(curl -sSL https://raw.githubusercontent.com/necvilen/hacking-tools/main/rededition.sh)
```
